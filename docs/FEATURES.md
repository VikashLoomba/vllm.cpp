...
| MiniMax-H3 DiT (`MiniMaxH3DiTModel`, vllm-omni lane) | MiniMax-H3 (33.1B video+audio) | portable 69/69 (ladder + ref2va DiT rung + seq 1920); t2va+fl2va COHERENT; vision→cond scatter gated; ref2va assembly FIXED+gated but grids, RE-ATTRIBUTED to the NVFP4 checkpoint/loader, NOT assembly (§8.10) | FP4/Marlin landed; ref2va NVFP4-checkpoint load path + speed pending |
