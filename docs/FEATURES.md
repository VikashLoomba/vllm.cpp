...
| Downloadable server binaries | ◐ W5 mutation-gated manifest contract implemented; no archives published | ✅ wheels/containers | ✅ wheels/containers | ✅ host-specific binaries |
