...
| MiniMax-H3 (`MiniMaxH3DiTModel`, omni-modal video+audio DIFFUSION) | **t2va+fl2va COHERENT; ref2va NVFP4 fp4-nibble bug FIXED** | ref2va grid = fp4 HIGH-first (loader read low-first→scrambled, byte-verified vs coherent GGUF); grid PERSISTS, 2nd NVFP4-path defect §8.11 |
