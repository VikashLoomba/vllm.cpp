...
**Records-only repairs; no capability change.** 2026-07-31: six `DONE` rows re-pointed at closure commits. 2026-08-06 audit (in progress): 6/10 stale `ACTIVE` rows → `READY`; 9 claims retired.
