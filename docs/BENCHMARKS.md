...
| **Container images (READY 2026-08-10)** | `ENG-RELEASE-CONTAINERS`: GHCR lanes `-cuda`/`-vulkan`/`-cpu`, amd64+arm64 ([spec](../.agents/specs/container-images.md)) | **No number owed:** nothing built or pushed. `PENDING`: per-lane image size; GB10 in-container first-`/health` | n/a |
