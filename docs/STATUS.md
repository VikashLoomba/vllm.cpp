...
| Kimi-Linear-48B-A3B (KDA + NoPE-MLA + MoE hybrid) | e2e RUNS (bf16-resident §13); bf16-regime knobs 106→120/128 (7/8 exact), NOT STRICT; default OFF | CPU+CUDA 13/13·656. bf16 residual+island-inputs → 120/128 (§14); 1 near-tie left (p7). STRICT+speed residual = device islands (per-channel GDN kernel + paged FA2). 1.30 tok/s; vLLM HW-can't-serve bf16 on 1 GB10 |
