...
| Kimi-Linear-48B-A3B (KDA + NoPE-MLA + MoE hybrid) | §8 oracle golden CAPTURED (STRICT); bf16-resident brick: pool math CLOSES, design grounded (§13); impl pending | 12/12·614 GREEN; §8 golden 8/8 DETERMINISTIC K=3 (STRICT), committed. bf16-resident loader/forward DESIGNED §13 (Laguna cast-GEMM + OwnedTensor d_dev); pool math ~94 GiB / ~25 GiB headroom CLOSES; impl pending |
