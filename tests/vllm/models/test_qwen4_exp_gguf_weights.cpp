...
// The synthetic file, its geometry and `LoadThroughRegistry` live in
// `tests/support/qwen4_exp_gguf_fixture.h` — ONE builder, shared with the W5b
// forward suite. See that header for why every dimension is the value it is.
using namespace qwen4_exp_fixture;  // NOLINT(build/namespaces) — the fixture IS this suite's vocabulary
