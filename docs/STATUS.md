...
|---|---|---|
| Qwen3.6-27B (NVFP4) text generation | Correctness-complete, at/above vLLM speed | Token-exact greedy GB10; beats vLLM 0.25.0 tput every c (1.007-1.045x), parity 115/124. FP8/NVFP4 heads load (#164); C10 needs a pin move |
