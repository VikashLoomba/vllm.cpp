// Qwen4-Exp W2 — host reference for the two components that had no vLLM op when
// this file was written. vLLM implements both since `e126687a9a`, 2026-08-31;
// `qwen4_exp_ple.h` carries the correction and the anchors (#2489).
