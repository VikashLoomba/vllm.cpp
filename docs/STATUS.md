...
| Kimi-Linear-48B-A3B (KDA + NoPE-MLA + MoE hybrid) | e2e RUNS (bf16-resident §13); per-channel-decay KDA device kernel `vt::KdaGatedDeltaRule` LANDED+GB10: **106→122/128 + 4.24 tok/s (3.1×)**, beats §14's 120 on both axes, NOT STRICT; default OFF | CPU+CUDA 13/13·656 + `test_ops_kda_recurrence` 4/4 (§15). p7 near-tie left; residual = KDA chunked-prefill + paged FA2 MLA + incremental (§15) |
