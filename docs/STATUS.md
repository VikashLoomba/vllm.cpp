...
| Qwen3.6-35B-A3B (NVFP4, GDN MoE) | Correctness-complete; fresh 3-rep grid 2026-08-05: 0.93-1.03x | Token-exact greedy (grid gate=0); tput c4 wins 1.025x, c16 worst 0.932x, TTFT 0.93-0.98x; c1 closed 0.817→0.977 since prior binding; c16 regression suspect = the async-UAF drain sync |
