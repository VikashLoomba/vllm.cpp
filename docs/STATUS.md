...
| MiniMax-H3 (`MiniMaxH3DiTModel`, omni-modal video+audio DIFFUSION) | **t2va COHERENT on GB10; guard landed; vision tower → real weights** | fl2va renders a matched cat on GB10; mismatch RAISES via `_resolve_task`; vision tower RUNS on real weights; ref2va grids. §8.6-8.8. |
