...
| Parakeet/FastConformer ASR (P1-P4) | **No number measured, claimed or owed.** Correctness-gated only, CPU f32. Real transcript verified on `nvidia/parakeet-ctc-0.6b`. | Floor is parakeet.cpp when a number is owed |
