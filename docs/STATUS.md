...
**Records-only repairs; no capability change.** 2026-07-31: six `DONE` rows re-pointed at closure commits. 2026-08-06 audit: all 10 stale `ACTIVE` rows → `READY`; 11 claims retired, 9 amended.
