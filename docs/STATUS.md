...
| MiniMax-H3 (`MiniMaxH3DiTModel`, omni-modal video+audio DIFFUSION) | **t2va+fl2va COHERENT; ref2va assembly FIXED+gated** | fl2va matched cat; ref2va block-dim bug fixed but grid RE-ATTRIBUTED to the NVFP4 ckpt (t2va-no-refs grids too), NOT assembly. §8.6-10. |
