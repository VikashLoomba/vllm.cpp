...
| Surface coverage (`ARCH-ONE-SURFACE`) | ROW 8 + #139 IN; **ROW 6 PARTIAL on main (`57ed063e`)** — `LlamaModel` live through PoolingRunner, `vllm_embed` v15 and `/v1/embeddings`; 7 memberships + real-oracle cosine remain | Real-checkpoint oracle cosine, then sibling memberships |
