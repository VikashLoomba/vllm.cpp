...
| CPU backend vs llama.cpp | 20-core Arm/i8mm at floor; RPi5/A76 `GATING` | Prefill 1.18x, decode/RSS parity, byte-exact tokens. Pi R2-R3: 16/16 x86-token exact; Q8 dot 20.10% of cycles; SDOT A/B + Pi llama.cpp floor open |
