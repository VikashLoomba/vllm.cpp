...
| MiniMax-H3 lane | **W-FP4a GB10 leg LANDED** (`row/H3-FP4-GPU-E2E`, PR #64): Marlin W4A16 byte-exact, fp4=MEMORY win; e2e RUNS but frame=non-scene patch-grid | **OPEN: render bug**; fp4 CLOSED |
