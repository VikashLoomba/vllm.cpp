...
| MiniMax-H3 (`MiniMaxH3DiTModel`, omni-modal video+audio DIFFUSION) | **t2va COHERENT on GB10; task/partition guard landed** | #70/#74 white was WRONG-PARTITION (t2va on ref2va); t2va on FL2VA GGUF renders a prompt-matched frame. Mismatch now RAISES like `_resolve_task`. spec §8.6-8.7. |
