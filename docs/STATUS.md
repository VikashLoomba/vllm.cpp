...
| MiniMax-H3 (`MiniMaxH3DiTModel`, omni-modal video+audio DIFFUSION) | **Portable lane COMPLETE; e2e video RAN (Thor); FP4 routing CPU-landed, GB10 pending** | Portable path COMPLETE (DiT 1.6e-7, VAEs, encoder, t2va, GGUF+NVFP4 loaders, /v1/videos); e2e video (Thor); W-FP4a fp4-resident Marlin-W4A16 routing CPU-gated, GB10 pending. Detail: spec §8. |
