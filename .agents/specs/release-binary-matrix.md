...
first implementation slice is W1's cross-family per-source-gencode prerequisite,
followed by multi-SM AOT dispatch and CPU ISA audits before any bundle workflow.
