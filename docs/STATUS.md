...
| Kimi-Linear-48B-A3B (KDA + NoPE-MLA + MoE hybrid) | device COMPUTE GPU-verified; §8 oracle golden CAPTURED (STRICT); full e2e f32-loader-blocked | `test_kimi_linear_forward` 12/12·614 GREEN on GB10; §8 golden 8/8 prompts DETERMINISTIC over K=3 (STRICT), committed; full-model our e2e blocked: loader materializes f32 (~183 GiB > 119 pool), needs bf16 path |
